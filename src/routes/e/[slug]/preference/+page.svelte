...
<article class="mx-auto max-w-2xl py-10">
	...
	<form method="post" action="?/submit" use:enhance class="mt-6 space-y-4">
		...
		<label class="block">
			<span class="text-sm text-gray-700">Weekdays you're available</span>
			<input
				name="byDay"
				required
				placeholder="MO,WE"
				value={form?.values?.byDay ?? ''}
				class="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 font-mono uppercase"
			/>
		...
		<div class="grid gap-4 sm:grid-cols-2">
			<label class="block">
				<span class="text-sm text-gray-700">Start of slot (local)</span>
				<input
					type="datetime-local"
					name="dtstartLocal"
					required
			...
			<label class="block">
				<span class="text-sm text-gray-700">Duration (minutes)</span>
				<input
					type="number"
		...
		<div class="grid gap-4 sm:grid-cols-2">
			<label class="block">
				<span class="text-sm text-gray-700">Available from (optional)</span>
				<input
					type="date"
					name="windowStart"
			...
			<label class="block">
				<span class="text-sm text-gray-700">Available until (optional)</span>
				<input
					type="date"
					name="windowEnd"
		...
		<label class="block">
			<span class="text-sm text-gray-700">Notes for the researcher (optional)</span>
			<textarea
				name="notes"
				rows="3"
				class="mt-1 w-full rounded-md border border-gray-300 px-3 py-2"
